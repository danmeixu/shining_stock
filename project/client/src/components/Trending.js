...
// 			if (!genreList) return;
//
// 			let decadesDivs = genreList.map((genreObj, i) =>
//
// 			<option value={genreObj.decade}>{genreObj.decade}</option>
//
// 			);
//
//
...
//       if (!movieList) return;
//
//       let genreDivs = movieList.map((movInfo, i) =>
// 			<div key={i} className="movieResults">
// 				<div className="genre">{movInfo.genre}</div>
// 				<div className="rating">{movInfo.avg_rating}</div>
// 			</div>
//
//         );
//
